...
import hexdoc_hex_wards

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class Hex_wardsPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return Hex_wardsModPlugin(branch=branch)


class Hex_wardsModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hex_wards"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hex_wards, "_templates"
